...
//
// Add a `weight =` attribute to the `#[pallet::call]` macro.
// Used in https://github.com/paritytech/substrate/pull/13932
// Call with Substrate root folder. Commit your git before using.
